...
Vícerotorové bezpilotní helikoptéry jsou užitečné v mnoha úrovních výzkumu.
...
Značné úsilí věnujeme výzkumu klíčových sub-systémů fungování vícerotorových UAV.
Systémy lokalizace, estimace stavu, modelování, zpětnovazební řízení, plánování pohybu, a autonomní navigace jsou již zavedené a aktivními poli výzkumu.
...
Konkrétně zde představujeme aplikaci skupin autonomních UAV misí pro kolaborativní sběr objektů a jejich dopravení na zadaná místa.
...
Všechny tyto výzvy byly vyřešeny spolu s vývojem kompletních bezpilotních systémů a jejich experimentální evaluace, která byla završena výhrami v obou mezinárodních soutěžích.
