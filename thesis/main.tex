...
\begin{figure}
  ...
  \subfloat {\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (a) at (0,0) { \includegraphics[height=10em]{./fig/photos/uvdar.jpg}};
  ...
  \hfill%
  \subfloat {\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (a) at (0,0) { \includegraphics[height=10em]{./fig/photos/uvdar_camera.jpg}};
    \begin{scope}[x={(a.south east)},y={(a.north west)}]
      %%{ grid
      % % useful grid to help you find coordinates for plotting the overlay
      % \draw[black, xstep=.1, ystep=.1] (0,0) grid (1,1);
