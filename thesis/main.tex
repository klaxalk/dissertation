...
The author of this thesis has contributed to various sub-fields of multi-\ac{UAV} research, inc. multi-\ac{UAV} swarming \cite{petracek2020bioinspired, saska2020formation, ahmad2020autonomous, dmytruk2020safe}, search and rescue \cite{roucek2019darpa, petrlik2020robust}, and planning and control \cite{penicka2017dubins, giernacki2019realtime, saikin2020wildfire, silano2020power}.

However, most of the effort has been invested to the research scenarios proposed by the Khalifa University as the first \ac{MBZIRC} robotic challenge.
The following core publication in this thesis proposes a \ac{UAV} system for autonomous landing on a moving car.
...
The system was evaluated extensively in simulations and various real-world conditions, and the final experiments were performed at the constrained environment of the competition venue.
\fullciteinbox{baca2019autonomous}{}
\noindent

The second challenge in \ac{MBZIRC} 2017 competition focused on collaborative gathering of metal objects using a group of \acp{UAV}.
The following two core publications focus on the autonomous \ac{UAV} system developed for autonomous localization \cite{stepan2019vision}, grasping and delivery of the metal objects.
The first publication describes the complete system for estimation of the detected objects, distributed gathering, and delivery of the objects to a designated area.
\fullciteinbox{spurny2019cooperative}{}
\noindent
The second publication describes the process of experimental preparation and evaluation of the system in a challenging desert environment, prior to the \ac{MBZIRC} competition.
The proposed system not only performed consistently during all the competition trials, but also managed to win the first place among the most prestigious universities in the world.
...
The project no. FW01010317 (2020 -- 2022, 8th of 384 submitted for the call\footnote{\url{https://www.tacr.cz/soutez/program-trend/prvni-verejna-soutez-trend}}) ``\textit{Localization of ionizing radiation soures using small unmanned helicopters equipped with a Compton camera detector}'', co-written by the thesis author, focuses on utilizing the unique properties of the Timepix3 event cameras for real-time localization and tracking of compact radiation sources.
...
\includepaperwithimage{baca2020gamma}
