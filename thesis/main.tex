...
A team of 3 \acp{UAV} was tasked with gathering colored metal discs that were either stationary and moving (attached to ground mobile robots).
...
Furthermore, it is concluded that the Compton camera principle shows promising properties and presents a real-time Monte-Carlo simulation model for the Compton camera.
...
The task of autonomous landing with a \ac{UAV} on top of a moving car \cite{baca2019autonomous} was also investigated, with a total of second place in the competition and the fastest autonomous landing time among all the competing teams.
