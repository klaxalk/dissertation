...
To obtain the posterior probability density of the scattering under by the angle $\theta$, we multiply the likelihood (\ref{eq:compton_likelihood}) by the prior probability of the Compton scattering:
\begin{equation}
