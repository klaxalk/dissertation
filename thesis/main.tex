...
Ongoing research realized in the scope of the Technology Agency of the Czech Republic project no. FW01010317 (2020 -- 2022) ``\textit{Localization of ionizing radiation soures using small unmanned helicopters equipped with a Compton camera detector}''.
The project proposal was co-written by the thesis author and was motivated by the author's previous work on radiation measurement and mapping \cite{baca2016miniaturized, baca2018timepix, baca2018rospix, stibinger2020localization} and the work on remote sensing with \acp{UAV}.
