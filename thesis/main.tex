...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.0em and 1.0em, auto]
    ...
    \keyarticle{below=of baca2018rospix,shift={(-4.0em, -0.8em)}}{baca2019timepix}{\tabcite{baca2019timepix}}{
      \begin{tabular}{l}
        Radiation mapping\\
        with Timepix sensor\\
        onboard UAV\\
  ...
  %%{ paths
    ...
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- smrcka2020admittance.north) + (1.0em, 1.0em)$) -- ($(smrcka2020admittance.north) + (0.0em, 1.0em)$) edge [->] ($(smrcka2020admittance.north) + (0.0em, 0.0em)$);
