...
The author was responsible for the design, development and commissioning of the satellite's payload and is responsible for the in-orbit data acquisition and data processing.
This research represents the author's first step into the community of particle imaging and radiation dosimetry and represents an important milestone in his work.
Without these contributions and gained know-how, the following work on radiation localization and mapping would probably has not been possible.
...
The article discusses the key properties of the detector and how they relate to various methods of obtaining a directional measurement to a radiation source, such as pinhole apertures, X-ray optics and collimators.
To facilitate the use of the Timepix sensor, a method for classification of the measured particle track is proposed.
The proposed classifier, as well as \ac{ROS} drivers 
...
The next core publication in this field focuses on distributed localization of radiation sources using multiple \acp{UAV} equipped with the Timepix sensor.
