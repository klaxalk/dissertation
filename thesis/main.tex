...
\usepackage[a4paper,margin=3.2cm,inner=3.2cm,outer=2.2cm]{geometry}
...
\newcommand{\includepaperwithimage}[2]{
  \ifdefined\includepdfs
    \ifdefined\printversion
      \includepdf[pages={-},offset=0.5cm 0cm,#2,clip=true,pagecommand={\thispagestyle{full}},width=1.0\textwidth]{./papers_to_include_pdf/#1}
    \else
...
\includepaperwithimage{baca2018timepix}{trim={25mm 20mm 25mm 20mm}}
