...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.0em and 1.0em, auto]
    ...
    \begin{pgfonlayer}{background}
      ...
      \path[fill=black!10, draw=black!50, dashed]
      (a) rectangle (b);
    ...
    \keyarticle{below=of baca2018model}{petrlik2020robust}{\tabcite{petrlik2020robust}}{
      \begin{tabular}{l}
        Robust UAV system\\
        for constrained\\
        environment\\
    ...
    \technology{below=of petrlik2020robust}{mrs_uav_system_technology}{
      \begin{tabular}{l}
        MRS UAV System
      \end{tabular}
    }

    \subkeyarticle{below=of mrs_uav_system_technology,shift={(0em, 0em)}}{baca2020mrs}{\tabcite{baca2020mrs}}{
      \begin{tabular}{l}
        MRS UAV system\\
        for research\\
        evaluation\\
  ...
  %%{ paths
    ...
    \path[-] (baca2018model) edge [->] (petrlik2020robust); 
    \path[-] (petrlik2020robust) edge [->] (mrs_uav_system_technology); 
    \path[-] (mrs_uav_system_technology) edge [->] (baca2020mrs); 
