...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.0em and 1.0em, auto]
    ...
    \article{below=of rospix_technology}{baca2018rospix}{\tabcite{baca2018rospix}}{
      \begin{tabular}{l}
        Rospix: Timepix\\
        interface for Robot\\
        Operating System\\
    ...
    \article{right=of loianno2018localization,shift={(0em, 0em)}}{baca2017autonomous}{\tabcite{baca2017autonomous}}{
      \begin{tabular}{l}
        Autonomous UAV\\
        landing on a car\\
        \emph{ECMR 2017}
    ...
    \keyarticle{below=of loianno2018localization}{spurny2019cooperative}{\tabcite{spurny2019cooperative}}{
      \begin{tabular}{l}
        Cooperative object\\
        gathering by UAVs\\
        \emph{JFR 2019}
    ...
    \begin{pgfonlayer}{background}
      ...
      \path (spurny2019cooperative.south -| spurny2019cooperative.west)+(-0.2,-0.4) node (b) {};
    ...
    \subarticle{below=of baca2020mrs,shift={(0em, -0.85em)}}{smrcka2020admittance}{\tabcite{smrcka2020admittance}}{
      \begin{tabular}{l}
        Admittance UAV\\
        stabilization for\\
        building inspection\\
    ...
    \article{below=of spurny2019cooperative,shift={(0em, -1em)}}{faigl2017onsolution}{\tabcite{faigl2017onsolution}}{
      \begin{tabular}{l}
        On solution of\\
        Dubins touring\\
        problem\\
    ...
    \keyarticle{below=of baca2018rospix,shift={(-4.6em, -0.8em)}}{baca2019timepix}{\tabcite{baca2019timepix}}{
      \begin{tabular}{l}
        Radiation mapping\\
        with Timepix sensor\\
        onboard UAV\\
    ...
    \subarticle{below=of ahmad2020autonomous,shift={(-4.0em, -1.0em)}}{walter2020extinguishing}{\tabcite{walter2020extinguishing}}{
      \begin{tabular}{l}
        Extinguishing of\\
        ground fires\\
        by UAVs\\
  ...
  %%{ paths
    ...
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- petracek2020bioinspired.west) + (1.0em, 0.0em)$) edge [->] ($(petracek2020bioinspired.west) + (-0.6em, 0.0em)$);

    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- smrcka2020admittance.north) + (1.0em, 1.2em)$) -- ($(smrcka2020admittance.north) + (0.0em, 1.2em)$) edge [->] ($(smrcka2020admittance.north) + (0.0em, 0.0em)$);

    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- giernacki2019realtime.south) + (1.0em, -0.5em)$) -- ($(giernacki2019realtime.south) + (0.0em, -0.5em)$) edge [->] ($(giernacki2019realtime.south) + (0.0em, 0.0em)$);

    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- silano2020power.north) + (1.0em, 0.5em)$) -- ($(silano2020power.north) + (0.0em, 0.5em)$) edge [->] ($(silano2020power.north) + (0.0em, 0.0em)$);
