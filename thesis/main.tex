...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.0em and 1.0em, auto]
    ...
    \article{below=of stream_generic}{saska2013adhoc}{\tabcite{saska2013adhoc}}{
      \begin{tabular}{l}
        UAV-UGV\\
        formations unde\\
    ...
    \stream{below=of saska2013adhoc, shift={(0.00em, -4.5em)}}{uav_platform_stream}{
      \begin{tabular}{l}
        UAV platform\\
    ...
    \subarticle{below=of daniel2017xray}{urban2020rex}{\tabcite{urban2020rex}}{
      \begin{tabular}{l}
        X-Ray telescope\\
        on NASA's sounding\\
        rocket \emph{Acta}\\
        \emph{Astronautica 2020}
      \end{tabular}
    }
    ...
    \article{below=of baca2017autonomous}{baca2019autonomous}{\tabcite{baca2019autonomous}}{
      \begin{tabular}{l}
        Autonomous UAV\\
        landing on a car\\
        \emph{JFR 2019}
    ...
    \keyarticle{below=of mrs_uav_system_technology}{petrlik2020robust}{\tabcite{petrlik2020robust}}{
      \begin{tabular}{l}
        Robust UAV system\\
        for constrained\\
        environment\\
    ...
    \subkeyarticle{below=of petrlik2020robust,shift={(0em, 0em)}}{baca2020mrs}{\tabcite{baca2020mrs}}{
      \begin{tabular}{l}
        MRS UAV system\\
        for research\\
        evaluation\\
    ...
    \keyarticle{left=of urban2020rex,shift={(-3.5em, -1em)}}{baca2019timepix}{\tabcite{baca2019timepix}}{
      \begin{tabular}{l}
        Radiation mapping\\
        with Timepix sensor\\
        onboard UAV\\
    ...
    \article{below=of baca2019timepix,shift={(0.0em, 0em)}}{stibinger2020localization}{\tabcite{stibinger2020localization}}{
      \begin{tabular}{l}
        Radiation mapping\\
        with Timepix sensor\\
        by UAVs\\
    ...
    \subarticle{below=of stibinger2020localization,shift={(0.0em, 0em)}}{baca2020gamma}{\tabcite{baca2020gamma}}{
      \begin{tabular}{l}
    ...
    \subarticle{below=of baca2020mrs,shift={(0.0em, -7em)}}{walter2020extinguishing}{\tabcite{walter2020extinguishing}}{
      \begin{tabular}{l}
        Extinguishing of\\
        ground fires\\
        by UAVs\\
  ...
  %%{ paths
    ...
    \path[-] (rospix_technology) edge [->] (daniel2017xray); 
    ...
    \path[-] (mpc_tracker_technology) edge [->] ($(loianno2018localization.west) + (-0.5em, 0)); 
