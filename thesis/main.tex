...
This thesis addressed collaborative remove sensing by a group of \aclp{UAV}.
First, we focused on development of a control system for \acp{UAV} for experimental evaluation of new methods in realistic conditions.
The proposed system utilizes an \ac{MPC} tracking approach for generating feedforward control reference and  ... 
\todo{bla bla need some dinner}
