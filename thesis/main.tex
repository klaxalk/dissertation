...
\begin{figure}
  ...
  \begin{adjustbox}{height=0.90\textheight}
  ...
  \begin{tikzpicture}[node distance=1.0em and 1.0em, auto]
    ...
    \subarticle{right=of article_generic}{article_submitted}{2a}{
      \begin{tabular}{l}
        Submitted article
      \end{tabular}
    }
    ...
    \article{below=of stream_generic,shift={(0.0em, -2em)}}{saska2013adhoc}{\tabcite{saska2013adhoc}}{
      \begin{tabular}{l}
        UAV-UGV\\
        formations unde\\
    ...
    \article{right=of baca2016embedded, shift={(10.0em, 0.0em)}}{baca2016miniaturized}{\tabcite{baca2016miniaturized}}{
      \begin{tabular}{l}
        X-Ray telescope\\
        with Timepix sensor\\
        for VZLUSAT-1\\
    ...
    \node [rotate=90, left=of uav_platform_stream, shift={(-4.2em, 5em)}] {Pre-Ph.D research};
    
    %%}

    %%{ research stream headlines
    
    \stream{below=of saska2013adhoc, shift={(0.00em, -5.0em)}}{uav_platform_stream}{
      \begin{tabular}{l}
        UAV platform\\
    ...
    \article{below=of baca2018timepix}{baca2018rospix}{\tabcite{baca2018rospix}}{
      \begin{tabular}{l}
        Rospix: Timepix\\
        interface for Robot\\
        Operating System\\
    ...
    \technology{below=of baca2018rospix}{rospix_technology}{
      \begin{tabular}{l}
        Rospix: Timepix\\
        controller\\
        for ROS
    ...
    \article{below=of daniel2019inorbit}{daniel2017xray}{\tabcite{daniel2017xray}}{
      \begin{tabular}{l}
        X-Ray telescope\\
        for a sounding\\
        rocket experiment\\
    ...
    \subarticle{below=of daniel2017xray,shift={(0.0e, -14.7em)}}{urban2020rex}{\tabcite{urban2020rex}}{
      \begin{tabular}{l}
        X-Ray telescope\\
        on NASA's sounding\\
        rocket experiment\\
    ...
    \keyarticle{right=of loianno2018localization,shift={(0em, 0em)}}{baca2017autonomous}{\tabcite{baca2017autonomous}}{
      \begin{tabular}{l}
        Autonomous UAV\\
        landing on a car\\
        \emph{ECMR 2017}
    ...
    \keyarticle{below=of baca2017autonomous}{baca2019autonomous}{\tabcite{baca2019autonomous}}{
      \begin{tabular}{l}
        Autonomous UAV\\
        landing on a car\\
        \emph{JFR 2019}
    ...
    \article{below=of loianno2018localization}{spurny2018cooperative}{\tabcite{spurny2018cooperative}}{
      \begin{tabular}{l}
        Cooperative object\\
        gathering by UAVs\\
        \emph{JFR 2018}
    ...
    \begin{pgfonlayer}{background}
      \path (baca2017autonomous.east |- baca2017autonomous.north)+(+0.2, 0.2) node (a) {};
      \path (spurny2018cooperative.south -| spurny2018cooperative.west)+(-0.2,-0.4) node (b) {};
    ...
    \keyarticle{below=of $(mpc_tracker_technology.south |- baca2017autonomous.south)$}{baca2018model}{\tabcite{baca2018model}}{
      \begin{tabular}{l}
        Model Predictive\\
        Control Tracker\\
        for UAVs\\
    ...
    \technology{below=of baca2018model}{mrs_uav_system_technology}{
      \begin{tabular}{l}
        MRS UAV System
      \end{tabular}
    }

    \article{below=of mrs_uav_system_technology}{petrlik2020robust}{\tabcite{petrlik2020robust}}{
      \begin{tabular}{l}
        Robust UAV system\\
        for constrained\\
        environment\\
    ...
    \subkeyarticle{below=of petrlik2020robust,shift={(0em, -9.9em)}}{baca2020mrs}{\tabcite{baca2020mrs}}{
      \begin{tabular}{l}
        MRS UAV system\\
        for research\\
        evaluation\\
    ...
    \article{below=of spurny2018cooperative,shift={(0em, -1em)}}{faigl2017onsolution}{\tabcite{faigl2017onsolution}}{
      \begin{tabular}{l}
        On solution of\\
        Dubins touring\\
        problem\\
    ...
    \keyarticle{below=of rospix_technology,shift={(-4.0em, -0.8em)}}{baca2019timepix}{\tabcite{baca2019timepix}}{
      \begin{tabular}{l}
        Radiation mapping\\
        with Timepix sensor\\
        onboard UAV\\
    ...
    \subarticle{below=of stibinger2020localization,shift={(0.0em, -4.5em)}}{baca2020gamma}{\tabcite{baca2020gamma}}{
      \begin{tabular}{l}
    ...
    \subarticle{below=of baca2020mrs,shift={(8.0em, -0.5em)}}{walter2020extinguishing}{\tabcite{walter2020extinguishing}}{
      \begin{tabular}{l}
        Extinguishing of\\
        ground fires\\
        by UAVs\\
    ...
    \subarticle{below=of petracek2020bioinspired,shift={(0.0em, 0.0em)}}{kratky2020autonomous2}{\tabcite{kratky2020autonomous2}}{
      \begin{tabular}{l}
        DARPA Subt\\
        Urban exploration\\
        \emph{JFR 2020}
  ...
  %%{ paths
    ...
    \path[-] (baca2018timepix) edge [->] (baca2018rospix); 
    ...
    \draw[-] ($(baca2016miniaturized.west)$) -- ($(radiation_stream.north |- baca2016miniaturized.east) + (-2.5em, 0.0em)$) edge [->] ($(radiation_stream.north) + (-2.5em, 0.0em)$);
    ...
    \draw[-] ($(baca2016embedded.south)$) -- ($(baca2016embedded.south) + (0, -0.5em)$) -- ($(uav_platform_stream.north |-baca2016embedded.south) + (-4.0em, -0.5em)$) edge [->] ($(uav_platform_stream.north) + (-4.0em, 0em)$);
    ...
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) edge [->] ($(mrs_uav_system_technology.east |- stasinchuk2020multiuav.north) + (1.0em, 0.6em)$);
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- faigl2017onsolution.west) + (1.0em, 0.0em)$) edge [->] ($(faigl2017onsolution.west) + (0.0em, 0.0em)$);
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- roucek2019darpa.west) + (1.0em, 0.0em)$) edge [->] ($(roucek2019darpa.west) + (0.0em, 0.0em)$);
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- saikin2020wildfire.west) + (1.0em, 0.0em)$) edge [->] ($(saikin2020wildfire.west) + (0.0em, 0.0em)$);
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- petracek2020bioinspired.west) + (1.0em, 0.0em)$) edge [->] ($(petracek2020bioinspired.west) + (0.0em, 0.0em)$);
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (1.0em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- kratky2020autonomous2.west) + (1.0em, 0.0em)$) edge [->] ($(kratky2020autonomous2.west) + (0.0em, 0.0em)$);
    ...
    \path[-] (baca2018rospix) edge [->] (rospix_technology); 
    \path[-] (baca2019timepix) edge [->] (stibinger2020localization); 

    \draw[-] ($(rospix_technology.south) + (1.0em, 0.0em)$) -- ($(rospix_technology.south |- baca2020gamma.east) + (1.0em, 0.0em)$) edge [->] (baca2020gamma.east);
    \draw[-] ($(rospix_technology.south) + (1.0em, 0.0em)$) -- ($(rospix_technology.south |- urban2020rex.west) + (1.0em, 0.0em)$) edge [->] (urban2020rex.west);
    ...
    \path[-] (mpc_tracker_technology) edge [->] ($(loianno2018localization.west |- mpc_tracker_technology.east) + (-0.5em, 0)); 
