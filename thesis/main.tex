...
A path planning approach, that exploits the asymmetrical intensity measurement response of the detector, was designed to guide \todo{}.
...
\todo{brag about that the system as a whole needs to be competent and each part needs to work, but putting 100i\% into one part does solve it}

Although, those particular problems are probably not going to be pursued in future by our team, we can find overlap with the rest of our activities.
\todo{describe the overlap with out other projects, DARPA, aerial core}

\todo{claim that i will fully transition to ionizing radiation ...}
