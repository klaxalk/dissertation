...
We successfully showed a multi-robotic system for autonomous object gathering \cite{spurny2019cooperative} and autonomous wall construction \cite{baca2020autonomous}.
Both tasks were put to test during the MBZIRC 2017 and MBZIRC 2020 robotics competition, and both obtained the first prize among respected university teams from all over the world.
We also investigated the task of autonomous landing with a \ac{UAV} on top of a moving car.
This robotics problem might be in future a part of automatic remote sensing applications with \acp{UAV} deployed and recovered from a car.
...
Although we are not going to pursue those problem further, they served \todo{}
