...
In particular, two scenarios were studied in context of the \ac{MBZIRC} 2017 challenge.
The first scenario focuses on autonomous localization, transportation and delivery of objects by a team of \acp{UAVs}.
Furthermore, we investigate the task of autonomously landing a \ac{UAV} on a moving vehicle.
