...
Moreover, distributed state estimation can be applied in real time \cite{wan2000unscented}.

Distributed fire monitoring: \cite{pham2020distributed}\\
Distributed target interception: \cite{zhu2017distributed}
