...
The challenges arise from the inherently unstable dynamics of multirotor helicopters \cite{kumar2012opportunities}.
...
Both, the \ac{UAV} state estimation \cite{merino2006vision, burri2015robust} and feedback control \cite{lee2010geometric, goodarzi2015geometric} have been intensively studied during the past decade and are still very active field of research.
Multirotor helicopters are a versatile platform for carrying out remote sensing, environment sampling, and providing technological support and aid in rescue operations.
...
Commercial \ac{UAV} systems are often closed-source and provide features tailored mostly for photographers, video makers and hobby pilots.
