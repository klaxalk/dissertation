...
The aforementioned publications were motivation and a pre-cursor for project proposal for the Technology Agency of the Czech Republic.
The project no. FW01010317 (2020 -- 2022, 8th of 396 submitted for the call\footnote{\url{https://www.tacr.cz/soutez/program-trend/prvni-verejna-soutez-trend}}) ``\textit{RADRON: Localization of ionizing radiation soures using small unmanned helicopters equipped with a Compton camera detector}'', co-written by the thesis author, focuses on utilizing the unique properties of the Timepix3 event cameras for real-time localization and tracking of compact radiation sources.
The last core publication (submitted) presents initial project results of utilizing the Timepix3 event camera as a Compton camera sensor \cite{baca2019timepix} onboard a \ac{UAV}.
