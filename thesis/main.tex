...
The \ac{ROS} interface for Timepix \cite{baca2018rospix}, initially developed for a suborbital rocket experiment \cite{urban2020rex}, has allowed the technology transfer to the robotics field.
...
\noindent
Obtaining a feasible control reference that satisfies state constraints of the \ac{UAV} is a vital requirement for fast and precise feedback control.
...
Onboard computer vision \cite{stepan2019vision} and nonlinear state estimation were performed to predict the car's future motion.
...
The MBZIRC 2020 challenge inspired the third core publication in this research stream (submitted to \emph{Robotics \& Autonomous Systems}, after the first revision).
...
Both systems were put to the test during the MBZIRC 2017 and MBZIRC 2020 robotics competition, and both achieved first place among respected university teams from all over the world.
...
This can make the approaches narrowminded and detached from reality and potentially not applicable to a real-world robotics system.
...
We focus on developing a miniature \ac{UAV} equipped with a Compton camera based on the Timepix3 technology.
