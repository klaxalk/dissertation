...
The author was responsible for the design, development and commissioning of the satellite payload and is responsible for the in-orbit data acquisition and data processing.
...
Without these contribution, the following work on radiation localization and mapping would probably has not been possible.
...
The article discusses the properties of the detector, various methods of obtaining a directional measurement to a radiation source, and proposes a method for classification of the particle tracks measured by sensor.
...
Furthermore, this work presents verification of real-world measurements onboard a \ac{UAV} against a developed real-time Monte-Carlo ray-tracing simulation model.
