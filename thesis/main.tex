...
\newcommand{\includepaperwithimage}[1]{
  ...
  \fullciteinboxwithimage{#1}{Here will be the pdf of the paper}
}
...
The same applies to the use of multiple multirotor \ac{UAV} with even more added challenges.
...
The author's citations were extracted from the Web of Science~(WoS) catalogue.
...
The author has reached \mathbf{h-index} 7 in the time of writing the thesis.
