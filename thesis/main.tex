...
\newcommand{\includepaperwithimage}[2]{
  ...
  \else
    \clearpage
    \fullciteinboxwithimage{#1}{This place shall contain the full paper}
  \fi
}
...
Furthermore, the thesis is supported by additional authored publications, referenced as 9a -- 44a.
...
\begin{figure}
  ...
  \newcommand{\accarticle}[4]{
    \node[accarticle, #1] (#2) {\scalebox{0.9}{\tiny #4}\vspace{0.1em}};
    \node[cite] at (#2.south east) {\tiny #3};
  }

  \newcommand{\acckeyarticle}[4]{
    \node[acckeyarticle, #1] (#2) {\scalebox{0.9}{\tiny #4}\vspace{0.1em}};
    \node[keycite] at (#2.south east) {\tiny #3};
  }
  ...
  \begin{tikzpicture}[node distance=1.0em and 1.0em, auto]
    ...
    \accarticle{right=of roucek2019darpa,shift={(0.0em, 0.0em)}}{kratky2021autonomous2}{\tabcite{kratky2021autonomous2}}{
      \begin{tabular}{l}
        DARPA SubT\\
        UAV Urban\\
        exploration\\
    ...
    \accarticle{below=of roucek2019darpa,shift={(0em, 0em)}}{petracek2021large}{\tabcite{petracek2021large}}{
      \begin{tabular}{l}
        DARPA SubT\\
        Large-scale\\
        exploration\\
    ...
    \accarticle{below=of kratky2021autonomous2,shift={(0.0em, 0.0em)}}{roucek2021system}{\tabcite{roucek2021system}}{
      \begin{tabular}{l}
        DARPA SubT\\
        Multi-robot\\
        exploration system\\
    ...
    \accarticle{below=of roucek2021system,shift={(0em, 0em)}}{silano2021powerline}{\tabcite{silano2021powerline}}{
      \begin{tabular}{l}
    ...
    \article{left=of silano2021powerline,shift={(0em, 0em)}}{saikin2020wildfire}{\tabcite{saikin2020wildfire}}{
      \begin{tabular}{l}
    ...
    \acckeyarticle{below=of $(petrlik2020robust.south |- petracek2020bioinspired.south)$,shift={(0em, 0em)}}{baca2021mrs}{\tabcite{baca2021mrs}}{
      \begin{tabular}{l}
        MRS UAV system\\
        for research\\
        evaluation\\
    ...
    \accarticle{below=of $(daniel2017xray.south |- saska2020formation.south)$}{urban2021rex}{\tabcite{urban2021rex}}{
      \begin{tabular}{l}
        X-Ray telescope\\
        on NASA's sounding\\
        rocket experiment\\
    ...
    \accarticle{below=of petracek2020bioinspired,shift={(0em, 0em)}}{ahmad2021autonomous}{\tabcite{ahmad2021autonomous}}{
      \begin{tabular}{l}
        Autonomous UAV\\
        swarms without\\
        \acs{GNSS} and comm.\\
    ...
    \accarticle{right=of ahmad2021autonomous,shift={(0em, 0em)}}{dmytruk2021safe}{\tabcite{dmytruk2021safe}}{
      \begin{tabular}{l}
        Tightly-constrained\\
        UAV swarms\\
        without GNSS\\
    ...
    \accarticle{below=of $(stibinger2020localization.south |- saska2020formation.south)$}{baca2021gamma}{\tabcite{baca2021gamma}}{
      \begin{tabular}{l}
    ...
    \accarticle{below=of $(ahmad2021autonomous.south |- baca2021mrs.south)$,shift={(-4.0em, -1.0em)}}{walter2020extinguishing}{\tabcite{walter2020extinguishing}}{
      \begin{tabular}{l}
        Extinguishing of\\
        ground fires\\
        by UAVs\\
    ...
    \accarticle{right=of walter2020extinguishing,shift={(0.0em, -0em)}}{stasinchuk2021multiuav}{\tabcite{stasinchuk2021multiuav}}{
      \begin{tabular}{l}
        Autonomous\\
        target elimination\\
        by UAVs\\
    ...
    \accarticle{below=of baca2021mrs,shift={(0.0em, -1em)}}{smrcka2021admittance}{\tabcite{smrcka2021admittance}}{
      \begin{tabular}{l}
        Admittance UAV\\
        stabilization for\\
        building inspection\\
    ...
    \article{right=of stasinchuk2021multiuav,shift={(0.0em, -0em)}}{spurny2021autonomous}{\tabcite{spurny2021autonomous}}{
      \begin{tabular}{l}
        Autonomous UAV\\
        firefighting inside\\
        a building\\
    ...
    \accarticle{right=of spurny2021autonomous,shift={(0.0em, -0em)}}{pes}{\tabcite{stasinchuk2021multi2}}{
      \begin{tabular}{l}
        Multi-UAV target\\
        elimination\\
        \emph{ICRA, 2021}
    ...
    \accarticle{below=of spurny2021autonomous,shift={(0.0em, -0em)}}{walter2021extinguishing}{\tabcite{walter2021extinguishing}}{
      \begin{tabular}{l}
        Extinguishing of\\
        real fires\\
        by UAVs\\
    ...
    \accarticle{right=of walter2021extinguishing,shift={(0.0em, -0em)}}{horyna2021autonomous}{\tabcite{horyna2021autonomous}}{
      \begin{tabular}{l}
    ...
    \accarticle{below=of smrcka2021admittance,shift={(0.0em, -0em)}}{horla2021altune}{\tabcite{horla2021altune}}{
      \begin{tabular}{l}
        ALTUNE: inflight\\
        UAV controller\\
        tuning\\
    ...
    \begin{pgfonlayer}{background}
      \path (pes.east |- pes.north)+(+0.2, 0.2) node (a) {};
    ...
    \begin{pgfonlayer}{background}
      ...
      \path (ahmad2021autonomous.south -| ahmad2021autonomous.west)+(-0.2,-0.4) node (b) {};
      \path[fill=black!00, draw=black!50, dashed]
      (a) rectangle (b);
      \path ($(a |- b)$) -- node [midway, shift = {(0.0, 1.5em)}] {\begin{tabular}{c}
  ...
  %%{ paths
    ...
    \path[-] (daniel2017xray) edge [->] (urban2021rex);
    ...
    \draw[<-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (2.2em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (2.2em, 0.0em)$) edge [->] ($(mrs_uav_system_technology.east |- stasinchuk2021multiuav.north) + (2.2em, 0.6em)$);
    ...
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (2.2em, 0.0em)$) -- ($(mrs_uav_system_technology.east) + (2.2em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- smrcka2021admittance.north) + (2.2em, 1.2em)$) -- ($(smrcka2021admittance.north) + (0.0em, 1.2em)$) edge [->] ($(smrcka2021admittance.north) + (0.0em, 0.0em)$);
    ...
    \draw[-] ($(mrs_uav_system_technology.east)$) -- ($(mrs_uav_system_technology.east) + (2.2em, 0.0em)$) -- ($(mrs_uav_system_technology.east |- silano2021powerline.north) + (2.2em, 0.5em)$) -- ($(silano2021powerline.north) + (0.0em, 0.5em)$) edge [->] ($(silano2021powerline.north) + (0.0em, 0.0em)$);
    ...
    \path[-] (roucek2019darpa) edge [->] (kratky2021autonomous2);
    \draw[-] ($(roucek2019darpa.south) + (1.0em, 0.0em)$) -- ($(roucek2019darpa.south) + (1.0em, -0.5em)$) -- ($(roucek2021system.north) + (0.0em, 0.5em)$) edge [->] (roucek2021system.north);
    \draw[-] ($(roucek2019darpa.south)$) edge [->] (petracek2021large.north);
    \path[-] (petrlik2020robust.east) edge [<->] (roucek2019darpa.west);

    \draw[-] ($(rospix_technology.east) + (0.0em, 0.0em)$) -- ($(rospix_technology.east) + (0.5em, 0.0em)$) -- ($(rospix_technology.east |- baca2021gamma.west) + (0.5em, 0.0em)$) edge [->] (baca2021gamma.east);
    \draw[-] ($(rospix_technology.east) + (0.0em, 0.0em)$) -- ($(rospix_technology.east) + (0.5em, 0.0em)$) -- ($(rospix_technology.east |- urban2021rex.west) + (0.5em, 0.0em)$) edge [->] (urban2021rex.west);
    ...
    \path[-] (petrlik2020robust) edge [->] (baca2021mrs);
  ...
  \caption{
    Diagram of research performed by the thesis author from 2013 to 2021 in the fields of UAV control, remote sensing and its applications, and the field of ionizing radiation imaging, dosimetry, mapping and localization.
...
\noalign{\smallskip}\hline
    \small platform                       & \small modular    & \small simulation & \begin{tabular}{@{}c@{}} \small outside \\ [-0.1em] \small lab.\end{tabular} & \begin{tabular}{@{}c@{}} \small multi-frame \\ [-0.1em] \small localization\end{tabular}  & \begin{tabular}{@{}c@{}} \small rate \\ [-0.1em] \small output\end{tabular} & \begin{tabular}{@{}c@{}} \small last \\ [-0.1em] \small updated\end{tabular} & \small reference \\
      \noalign{\smallskip}\hline\hline\noalign{\smallskip}
    \small \small \textbf{MRS UAV system} & \small \textbf{+}                   & \small \textbf{+} & \small \textbf{+} & \small \textbf{+}                        & \small \textbf{+}                       & \small \textbf{2020}                         & \cite{baca2021mrs}                                       \\
...
Our solution \cite{baca2020autonomous, baca2021mrs} again managed to win first place among many prestigious university teams in the world.
...
Further research led to a design of a one-time sub-orbital rocket experiment \cite{daniel2017xray, urban2021rex}.
...
The \ac{ROS} \acs{API} for Timepix \cite{baca2018rospix}, initially developed for a suborbital rocket experiment \cite{urban2021rex}, allows the technology to transfer to the robotics field.
...
Moreover, the Compton camera mechanism \cite{turecek2018compton}, is being utilized to provide the smallest real-time single-sensor Compton camera ever used on a \acp{UAV} \cite{baca2021gamma}.
...
\includepaperwithimage{baca2021mrs}{trim={14mm 20mm 20mm 15mm}}
...
The author of this thesis has contributed to various subfields of multi-\ac{UAV} research, including multi-\ac{UAV} swarming \cite{petracek2020bioinspired, saska2020formation, ahmad2021autonomous, dmytruk2021safe}, search and rescue \cite{roucek2019darpa, petrlik2020robust, kratky2021autonomous2, roucek2021system}, planning and control \cite{penicka2017dubins, giernacki2019realtime, saikin2020wildfire, silano2021powerline, spurny2016complex}, and sensing \cite{stibinger2020localization, baca2018rospix, kratky2021autonomous2}.
...
Moreover, a novel multi-frame state estimation framework was proposed for seamless switching between globally-localized flight and egomotion visual servoing \cite{baca2021mrs}.
...
The thesis author designed a hardware readout interface and software, based on the \acl{ROS} \cite{baca2018rospix}, for two Timepix detectors onboard a sub-orbital rocket \cite{urban2021rex}.
...
The proposed \ac{UAV} system \cite{baca2021mrs, baca2018model} provides students and researchers the means to develop and test new methods in the field of feedback control, tracking, estimation, and planning.
...
The MRS \ac{UAV} system \cite{baca2021mrs} comes with two controller designs --- extended \emph{SE(3) geometric tracking} \cite{lee2010geometric} for agile and aggressive flight and the novel \emph{MPC controller} for stable flight in case of potentially unreliable \ac{UAV} state estimate.
...
Therefore, relatively simple controllers \cite{baca2021mrs} with well-tractable inner mechanisms are utilized.
Moreover, we still find even relatively old concepts \cite{lee2010geometric} to be worth improving by incremental and implementation ways, as described in \cite{baca2021mrs}.
...
For example, we also pursue the \ac{DARPA} Subterranean competition on multi-robotic autonomous localization of objects and people in underground environments \cite{roucek2019darpa, kratky2021autonomous2, petrlik2020robust}.
Furthermore, the primary research on relatively-localized multi-\ac{UAV} swarms \cite{petracek2020bioinspired, saska2020formation, ahmad2021autonomous, dmytruk2021safe} benefits significantly from the systems and expertise we obtained in experimental field robotics.
...
The first project results, submitted to \emph{IEEE ICRA} \cite{baca2021gamma}, show the Timepix3 event camera used as a single-detector Compton camera onboard a \ac{UAV}.
...
\fullciteinbox{baca2021gamma}{}
The future work in this research field is co-aligned with the project goals.
We focus on developing an \ac{MAV} equipped with a Compton camera based on the Timepix3 technology and aim to combine the Compton camera principle \cite{baca2021gamma} for localization of compact gamma sources, together with the count-based system \cite{stibinger2020localization} that can be utilized for ionizing charged particles.
