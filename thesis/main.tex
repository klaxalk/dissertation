...
\cite{lee2010geometric}
\cite{lee2013nonlinear}
...
% \begin{figure}
%   \centering
%   \adjustbox{max width=\linewidth}{\input{./fig/tikz/pipeline_diagram.tex}}
...
% \begin{figure}
%   \centering
%   \input{./fig/tikz/tracker_diagram.tex}
%   \label{fig:mrs_platform_all}
%   \caption{TODO}
% \end{figure}
...
%% --------------------------------------------------------------
%% |           Chapter 5 - advances in UAV deployment           |
%% --------------------------------------------------------------
...
\section{Automatic target following with a UAV}
...
Principle published in \cite{turecek2018compton, baca2019timepix}.
